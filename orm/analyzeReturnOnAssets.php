...
class analyzeReturnOnAssets extends orm{
	...
	public static function getList(){
        $db = new db;
		$result = $db->query("SELECT k.CompanyId, c.CompanyName, c.Symbol, k.ReturnOnAssets FROM keystats k INNER JOIN company c ON c.Id=k.CompanyId ORDER BY ReturnOnAssets DESC LIMIT 250");
