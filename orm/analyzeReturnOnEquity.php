...
class analyzeReturnOnEquity extends orm{
	...
	public static function getList(){
        $db = new db;
		$result = $db->query("SELECT k.CompanyId, c.CompanyName, c.Symbol, k.ReturnOnEquity FROM keystats k INNER JOIN company c ON c.Id=k.CompanyId ORDER BY ReturnOnEquity DESC LIMIT 50");
